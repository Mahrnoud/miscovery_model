...
if __name__ == "__main__":
    ...
    parser.add_argument("--eval_steps", type=int, default=30000, help="Evaluate every N steps")
    ...
    parser.add_argument("--output_dir", type=str, default="/kaggle/working/256_v3/stage_01/output",
                        help="Output directory")
    parser.add_argument("--cache_dir", type=str, default="/kaggle/working/256_v3/stage_01/cache",
